...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_SKELETON,           SK_CHARMS,         -2),
    APT(SP_SKELETON,           SK_SUMMONINGS,     -1),
    APT(SP_SKELETON,           SK_NECROMANCY,      0),
    ...
    APT(SP_SKELETON,           SK_AIR_MAGIC,      -3),
    APT(SP_SKELETON,           SK_EARTH_MAGIC,     1),
    APT(SP_SKELETON,           SK_POISON_MAGIC,   -4),
    APT(SP_SKELETON,           SK_INVOCATIONS,    -3),
