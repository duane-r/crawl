...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_SKELETON,           SK_DODGING,         2),
    APT(SP_SKELETON,           SK_STEALTH,        -1),
    APT(SP_SKELETON,           SK_STABBING,       UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_SHIELDS,         2),
    APT(SP_SKELETON,           SK_TRAPS,          UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_UNARMED_COMBAT, -2),
    APT(SP_SKELETON,           SK_SPELLCASTING,   UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_CONJURATIONS,   UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_HEXES,          UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_CHARMS,         UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_SUMMONINGS,     UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_NECROMANCY,     UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_TRANSLOCATIONS, UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_TRANSMUTATIONS, UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_FIRE_MAGIC,     UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_ICE_MAGIC,      UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_AIR_MAGIC,      UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_EARTH_MAGIC,    UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_POISON_MAGIC,   UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_INVOCATIONS,    UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_EVOCATIONS,     UNUSABLE_SKILL),
};
